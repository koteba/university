...
<div class="input-group-append">
 ...
 <div class="form-group row">
                            <label for="specification" class="col-md-4 col-form-label text-md-right">{{ __('teacher.specification') }}</label>

                            <div class="col-md-6">
                                <input id="specification" type="text" class="form-control @error('specification') is-invalid @enderror" name="specification" value="{{ old('specification') }}" required autocomplete="specification" autofocus>
...
<div class="form-group row">
                            <label for="specification_en" class="col-md-4 col-form-label text-md-right">{{ __('teacher.specification_en') }}</label>

                            <div class="col-md-6">
                                <input id="specification_en" type="text" class="form-control @error('specification_en') is-invalid @enderror" name="specification_en" value="{{ old('specification_en') }}" required autocomplete="specification_en" autofocus>
